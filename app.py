...
def initialize_llm():
    ...
    google_key = os.getenv('GEMINI_API_KEY')  # Updated to match the secret key name
...
def run_research():
    ...
    try:
        logging.debug(f"Starting research for query: {query}")
...
if __name__ == '__main__':
    if not agent_executor:
        ...
        print("Please ensure you have set GEMINI_API_KEY environment variable")
